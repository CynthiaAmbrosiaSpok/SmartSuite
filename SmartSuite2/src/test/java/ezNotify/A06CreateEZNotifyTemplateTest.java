...
public class A06CreateEZNotifyTemplateTest extends TestBase {
	
	//Define Variable(s)
	SoftAssert checkpoint;
	
	//Constructor
	public A06CreateEZNotifyTemplateTest() {
		super();
	}
	...
	public void testcases_ezNotify_CreateEZNotifyTemplateTest(String active, String reportTitle, String eventName, String eventMessage, String shortMessage, String responseType, String responseTypeQuestion, String selectRepicientsIndividuals, String selectRepicientsMessageGroups, String selectRepicientsOncallGroups, String recipients, String addAdditionalOptions, String eventDuration, String deviceEscalation, String recipientDeviceList, String procedureDeviceList, String viewProcedureDeviceList, String dataRow) {
		...
		if (active.equalsIgnoreCase("y") || active.equalsIgnoreCase("yes")) {
			...
			performSetup(reportTitle, "06_testcases_ezNotify_CreateEZNotifyTemplateTest");
			...
			ezCreateEventPage.createEZNotifyTemplate(eventName, eventMessage, shortMessage, responseType, responseTypeQuestion, selectRepicientsIndividuals, selectRepicientsMessageGroups, selectRepicientsOncallGroups, recipients, addAdditionalOptions, eventDuration, deviceEscalation, recipientDeviceList, procedureDeviceList, viewProcedureDeviceList);
