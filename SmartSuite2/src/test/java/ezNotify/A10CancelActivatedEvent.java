...
public class A10CancelActivatedEvent extends TestBase {
	
	//Define Variable(s)
	SoftAssert checkpoint;
	
	//Constructor
	public A10CancelActivatedEvent() {
		super();
	}
	...
	public void testcases_ezNotify_CancelActivatedEvent(String active, String reportTitle, String eventName, String eventMessage, String shortMessage, String responseType, String responseTypeQuestion, String selectRepicientsIndividuals, String selectRepicientsMessageGroups, String selectRepicientsOncallGroups, String recipients, String eventDuration, String eventStatus, String ezNotifyEventStatus, String dataRow) {
		...
		if (active.equalsIgnoreCase("y") || active.equalsIgnoreCase("yes")) {
			...
			performSetup(reportTitle, "10_testcases_ezNotify_CancelActivatedEvent");
