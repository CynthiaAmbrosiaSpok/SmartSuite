...
public class OldA05CancelAdvancedOptionsTest extends TestBase {
	
	//Define Variable(s)
	SoftAssert checkpoint;
	
	//Constructor
	public OldA05CancelAdvancedOptionsTest() {
		super();
	}
	...
	public void testcases_ezNotify_CancelAdvancedOptionsTest(String active, String reportTitle, String eventDuration, String deviceEscalation, String recipientDeviceList, String procedureDeviceList, String dataRow) {
...
//			ezCreateEventPage.verifyCancelledNewEventPage(checkpoint);
