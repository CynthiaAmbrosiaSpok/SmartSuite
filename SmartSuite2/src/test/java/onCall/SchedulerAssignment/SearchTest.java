...
public class SearchTest extends TestBase {
	...
	public void beforeClass() {
		...
		excelMethods.setSheetName("Oncall Scheduler Search");
	}
	
	@Test(dataProvider="inputs", dataProviderClass=ExcelMethods.class)
	public void testcases_onCall_SchedulerAssignment_SearchTest(String active, String reportTitle, String groupNameSearchCriteria, String groupIDSearchCriteria, String expectedSearchResult, String dataRow) {
		...
		if (active.equalsIgnoreCase("y") || active.equalsIgnoreCase("yes")) {
			...
			performSetup(reportTitle, "testcases_OnCall_SchedulerAssignment_SearchTest()");
			...
			oncall_SchedulerAssignmentPage.verifySearchResults(checkpoint, expectedSearchResult);
