...
public class StatusUpdateTest extends TestBase {
	
	//Define Variable(s)
	SoftAssert checkpoint;
	
	//Constructor
	public StatusUpdateTest() {
		super();
	}
	...
	public void beforeClass() {
		...
		excelMethods.setSheetName("User Status");
	}
	
	@Test(dataProvider="inputs", dataProviderClass=ExcelMethods.class)
	public void testcases_personalProfile_Profile_StatusUpdateTest(String active, String reportTitle, String statusCode, String statusMessage, String expectedStatusCode, String expectedStatusMessage, String dataRow) {
		...
		if (active.equalsIgnoreCase("y") || active.equalsIgnoreCase("yes")) {
			...
			performSetup(reportTitle, "testcases_PersonalProfile_Profile_StatusUpdateTest()");
			...
			personalProfile_ProfilePage.updateUserStatus(statusCode, statusMessage);
			
			//Check if the search result matches expectation(s)
			personalProfile_ProfilePage.verifyUserStatus(checkpoint, expectedStatusCode, expectedStatusMessage);
