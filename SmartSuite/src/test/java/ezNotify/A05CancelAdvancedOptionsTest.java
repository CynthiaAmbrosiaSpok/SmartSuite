...
public class A05CancelAdvancedOptionsTest extends TestBase {
	
	//Define Variable(s)
	SoftAssert checkpoint;
	
	//Constructor
	public A05CancelAdvancedOptionsTest() {
		super();
	}
	...
	public void beforeClass() {
		...
		excelMethods.setSheetName("Cancel ezNotify Page");
	}
	
	@Test(dataProvider="inputs", dataProviderClass=ExcelMethods.class)
	public void testcases_ezNotify_CancelAdvancedOptionsTest(String active, String reportTitle, String defaultEventDuration, String defaultDeviceEscalation, String defaultRecipientDeviceList, String defaultProcedureDeviceList, String eventName, String eventMessage, String shortMessage, String responseType, String responseTypeQuestion, String selectRepicientsIndividuals, String selectRepicientsMessageGroups, String selectRepicientsOncallGroups, String recipients, String addAdditionalOptions, String eventDuration, String deviceEscalation, String recipientDeviceList, String procedureDeviceList, String cancelEventDuration, String cancelDeviceEscalation, String cancelRecipientDeviceList, String cancelProcedureDeviceList, String dataRow) {
		...
		if (active.equalsIgnoreCase("y") || active.equalsIgnoreCase("yes")) {
			...
			performSetup(reportTitle, "05_testcases_ezNotify_CancelAdvancedOptionsTest");
			...
			ezCreateEventPage.cancelAdvancedOptionsPage(eventDuration, deviceEscalation, recipientDeviceList, procedureDeviceList);
			
			//Verify that the ezNotify Event Page was Cancelled
			ezCreateEventPage.verifyCancelledNewEventPage(checkpoint, defaultEventDuration, defaultDeviceEscalation, defaultRecipientDeviceList, defaultProcedureDeviceList);
			...
			//Create the ezNotify Event
			ezCreateEventPage.createEZNotifyEvent(eventName, eventMessage, shortMessage, responseType, responseTypeQuestion, selectRepicientsIndividuals, selectRepicientsMessageGroups, selectRepicientsOncallGroups, recipients, addAdditionalOptions, eventDuration, deviceEscalation, recipientDeviceList, procedureDeviceList, "n");
			...
			//Enter the 'Procedure 1' Section of the ezNotify Template
			ezActivateEventPage.enterProcedureSection();
			
			//Retrieve the Amount of Existing ezNotify Events
			ezExistingEventPage.getExistingEventSize(eventName);
			
			//Modifying (then Canceling) the Event Template Info
			ezActivateEventPage.modifyEventTemplateProcedureInfo("y", cancelEventDuration, cancelDeviceEscalation, cancelRecipientDeviceList, cancelProcedureDeviceList);
